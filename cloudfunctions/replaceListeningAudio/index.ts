import { ReplaceListeningAudioRequest, ReplaceListeningAudioResponse } from '../../miniprogram/types/api';
...
export async function main(event: ReplaceListeningAudioRequest): Promise<ReturnType<typeof ok<ReplaceListeningAudioResponse>> | ReturnType<typeof fail>> {
  try {
